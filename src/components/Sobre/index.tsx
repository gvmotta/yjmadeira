    ...
    <Sobre className='container mb-5 pt-4'>
      <div className='row'>
        <div className='texto col-12 col-md-6 mb-sm-4'>
          ...
          <h6>Quer móveis ou estruturas de madeira com qualidade?</h6>
          <p>A YJ Madeira é uma empresa de design e fabricação de móveis e estruturas de madeira artesanal. Fundada em 2018, a empresa tem como objetivo criar móveis únicos e personalizados que combinem beleza, funcionalidade e durabilidade.</p>
          <p>A YJ Madeira oferece uma variedade de móveis, incluindo pergolados, decks, portas, painéis, escadas, guarda-corpos e armários. Tudo feito à mão com madeiras de alta qualidade, como mogno, jacarandá e imbuia.</p>
